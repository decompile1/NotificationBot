...
export default function MultiSelectMenu({
    ...
    return (
        <div className={cn("select-none w-full max-w-full mb-3 relative", className)}>
            ...
            <button
                className={cn(
                    "mt-1 min-h-12 w-full bg-foreground rounded-lg flex items-center px-3 duration-100 suspicious-modal",
                ...
                >
                    ...
                    {values.map((v) => (
                        <button
                            ...
                            className={cn(
                                "relative px-2 bg-foreground rounded-md flex items-center gap-1 suspicious-modal",
