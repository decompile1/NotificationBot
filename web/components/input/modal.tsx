...
export default function Modal<T>({
        ...
        return (
            <>
                <div className="flex items-center">
                    ...
                    <Button onClick={() => onClose()} className="ml-auto" size="icon">
                        <HiX />
                    </Button>
                </div>
    ...
    function Footer() {
        return (
            <div className="flex items-center w-full gap-6 p-4">
                ...
                <Button variant={variant} onClick={() => submit()} className={cn(!onSubmit && "ml-auto")} disabled={isDisabled}>
                    {buttonName}
                </Button>
    ...
    return (
        <MotionConfig transition={{ type: "spring", bounce: 0.4, duration: 1 }}>
                    ...
                    >
                        ...
                        >
                            <div className="p-4 pb-0">
                                ...
                                >
                                    {error && <Notice type={NoticeType.Error} message={error} />}
